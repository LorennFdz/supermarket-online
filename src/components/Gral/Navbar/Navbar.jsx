...
<nav className='navbar'>
        {!openNavbar ? (
          <>
          <figure onClick={handleNavbar} className="icon-menu icons-navbar">
            <IconMenu />
          </figure>
          <figure className="logo-mobile icons-navbar" title='Logo Supermarket'>
            <Link to={"/"} >
          ...
          <figure className='icons-navbar icon-shopping-cart'>
            <IconShoppingCart />
          </figure>
          </>
        ): 
        <>
          <figure onClick={handleNavbar} className="icon-close-menu icons-navbar">
            <IconClose />
          </figure>
        </>
        }
